export const landingFaqs = [
  {
    ...
    answer:
      "Um software de cobrança como o Fluxeer organiza o acompanhamento de faturas. Ele estrutura seu contas a receber, profissionaliza a régua de cobrança e traz previsibilidade real para o seu caixa.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Através da priorização por risco e da estruturação dos lembretes, o Fluxeer ajuda sua equipe a agir antes que o atraso cresça e pressione o caixa.",
  },
  {
    question: "Qual a vantagem de uma régua estruturada sobre o processo manual?",
    answer:
      "Uma régua estruturada garante consistência no processo, reduz esquecimentos, centraliza histórico e libera o time financeiro para tratar exceções e negociações críticas.",
  },
  {
...
export const moneyPages = [
  {
    ...
    description: "Organização da cobrança com mais visibilidade para o contas a receber.",
  },
  {
    href: "/regua-de-cobranca",
    title: "Régua de Cobrança",
    description: "Fluxos estruturados para agir no momento certo, sem improviso.",
  },
  {
